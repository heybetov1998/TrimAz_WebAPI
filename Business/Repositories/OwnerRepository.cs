...
public class OwnerRepository : IOwnerService
{
    ...
    public OwnerRepository(IImageService imageService, UserManager<AppUser> userManager, AppDbContext context)
    {
    ...
    {
        var datas = await _context.Users.Where(n => n.RoleName == "Owner")
            .Include(n => n.UserImages).ThenInclude(n => n.Image)
            .ToListAsync();
